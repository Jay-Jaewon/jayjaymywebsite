...
<p style="margin: auto; text-align: center; padding-top: 70px; padding-bottom: 50px;
font-size: 50px">
    회원가입
</p>
<form action="signup-request.php" onsubmit="return form_check()" method="post">
    <table width="940" style="padding:5px 0 5px 0; margin: auto;">
        <tr height="2" bgcolor="#bc8f8f"><td colspan="2"></td></tr>
        <tr>
            <th>아이디</th>
            <td>
                <input type="text" name="userID" id="id" maxlength="20"></td>
        </tr>
        <tr>
            <th>비밀번호</th>
            <td><input type="password" name="userPW" id="password" maxlength="16" onchange="password_check()"></td>
        </tr>
        <tr>
            <th>비밀번호 확인</th>
            <td><input type="password" id="password_re" maxlength="16" onchange="password_check()">&nbsp;&nbsp;<span id="password_check"></span></td>
        </tr>
        <tr>
            <th>*</th>
            <td><p>아이디/비밀번호는 영문과 숫자를 반드시 포함하고 6자이상 16자이하 이어야합니다. 한글은 사용할 수 없고, 아이디에는 특수문자를 사용할 수 없습니다.</p></td>
        </tr>
        <tr>
            <th>비밀번호 힌트</th>
        ...
        <tr>
            <th>닉네임</th>
            <td><input type="text" name="userNickName" id="nickname" maxlength="10"></td>
        </tr>
        <tr>
            <th>이름</th>
        ...
        <tr>
            ...
            <td>
                ...
                <input type='text' name="userEmailDNS" id="email_dns">
<!--                <select name="emailaddr" id="email_dns_selected" onchange="email_dns_selected()">-->
...
<!--                </select>-->
        ...
        <tr>
            <th>주소</th>
            <td>
                <input id="zonecode" type="text" value="" style="width:50px;" name="userPostCode" />
                <input type="button" onClick="openDaumZipAddress();" value="우편번호" /><br>
                <input type="text" id="address" value="" style="width:240px;" name="userAddress"/> 기본주소<br>
                <input type="text" id="address_etc" value="" style="width:200px;" name="userAddressDetail"/> 상세주소
            </td>
        </tr>
        <tr>
            <th>핸드폰 번호</th>
            <td><input type="text" name="userTel_1" id="tel_1" maxlength="3"> -
                <input type="text" name="userTel_2" id="tel_2" maxlength="4"> -
                <input type="text" name="userTel_3" id="tel_3" maxlength="4">
            </td>
        </tr>
        <tr>
            <th>생년월일</th>
        ...
        <tr>
            ...
            <td>
                <div style="margin: 20px; overflow: scroll; width:700px; height:150px; border: 1px solid black;">
                    <p>
                        본인은 몰에 개인정보를 제공함에 따라 [개인정보 보호법] 제15조 및 제17조에 따라
                        아래의 내용으로 개인정보를 수집, 이용 및 제공하는데 동의합니다.
                        □ 개인정보의 수집 및 이용에 관한 사항
                        - 수집하는 개인정보 항목 (회원가입양식 내용 일체) : 성명, 핸드폰 번호, 주소, 이메일, 학력사항, 생년월일 등과 그 外 회원가입 기재 내용
                        일체
                        - 개인정보의 이용 목적 : 수집된 개인정보를 사업장 관련 행정 처리, 매출통,물건 운송에 필요한 최소한의 정보로
        ...
        <tr>
            <td colspan="2" align="center">
                <input type="submit" value="회원가입" style="border-radius: 5px; background-color: antiquewhite">
                <input type="reset" value="취소" onclick="quit_signup()" style="border-radius: 5px; background-color: antiquewhite;">
            </td>
        </tr>
    </table>
</form>
