...
<div style="width: 1100px; margin: auto;">
    <p style="margin-top: 50px; font-size: 35px; font-weight: bolder; text-align: center;">회원정보 수정</p>
    <div style="width: 1100px; border: 1px solid #007bff; margin-top: 30px;"></div>
    <p style="font-size: 18px; text-align: center; font-weight: bolder;margin-top: 30px;">* 보안상 회원정보를 수정하기 위해서 비밀번호가 필요합니다.</p>
    <form action="pw-check-request.php" method="post" onsubmit="return checkPW()" style="text-align: center; margin-top: 50px;">
        <div>
            <label style="font-size: 20px; font-weight: bolder;" for="PW">비밀번호 : </label>
            <input style=" border: 1px solid #007bff; height: 40px;" type="password" id="PW" name="userPW">
        </div>
