...
<div style="width: 1100px; margin-left: auto; margin-right: auto; margin-top: 30px;">
    <div style="width: 1100px; margin-left: auto; margin-right: auto; margin-top: 30px;">
        ...
        <script type="text/javascript">
            ...
            switch (boardType) {
                case 1:
                    title.innerText = "시사게시판 글쓰기";
                    break;
                case 2:
                    document.getElementById('board-title').innerHTML = "IT/과학게시판 글쓰기";
                    break;
                case 3:
                    title.innerHTML = "자유게시판 글쓰기";
                    break;
                default:
                    alert("잘못된 접근입니다.");
        ...
        <div style="margin-top: 30px;width: 1100px; margin-left: auto; margin-right: auto;">
            <form onsubmit="return writef();" action="write-request.php?boardType='<?php echo $_GET['board'];?>'"  method="post">
                <input style="margin-bottom: 10px; width: 1100px; height: 30px; border: 1px solid black;" type="text" name="title" class="board_title" placeholder="제목을 입력해 주세요." maxlength="100";>
                <textarea id="summernote" name="contents"></textarea>
                <div style="margin-top: 50px;" align="center">
                    <input type="submit" class="write-button" value="작성">
<!--                    <input type="hidden" name="boardType" id="boardType">-->
                    <input type="button" class="write-button" value="취소" onclick="quit_write()">
                </div>
            </form>
        </div>
